...
const Footer = () => {
  return (
    <footer>
      <div class="bg-gray-200 py-4 text-black-400">
          ...
          <div class="-mx-4 flex flex-wrap justify-between">
            <div class="px-4 my-4 w-full xl:w-1/5">
              ...
              <p class="text-justify">
                ...
                giàu kinh nghiệm và tâm huyết. Nền tảng của chúng tôi kết nối
                học sinh với gia sư phù hợp nhất dựa trên nhu cầu học tập, trình
                độ và sở thích cá nhân.
              </p>
            </div>
