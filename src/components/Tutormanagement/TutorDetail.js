...
const TutorDetail = () => {
    ...
    if (tutorDetail) {
        console.log(tutorDetail.fullName)
    }
    return (
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-start md:space-x-6 mb-6">
                        ...
                        <div className="text-center md:text-left">
                            ...
                            <div className="flex items-center justify-center md:justify-start mt-2 text-gray-600">
                                ...
                                <p className="text-md">Môn học: {tutorDetail.profile.majorList.map((item) => item.subject.name + " ")}</p>
                            </div>
                            {/* <div className="flex items-center justify-center md:justify-start mt-2 text-gray-600">
                            ...
                            <div className="flex items-center justify-center md:justify-start mt-2 text-gray-600">
                                ...
                                <p className="text-md">Rating: {tutorDetail.profile.ratingPoint}/5.0</p>
                            </div>
                        </div>
                    </div>
