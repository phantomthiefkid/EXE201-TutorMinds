      ...
      <div className="flex justify-between items-start py-8 gap-10">
        <div className="w-full space-y-4">
          ...
          {filteredRequests.map((request) => (
            <div key={request.id} className="bg-white border border-gray-300 shadow-md p-6 flex items-start hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="flex flex-col flex-grow">
                ...
                <p className="text-gray-500 text-sm">ID: {request.id} - Ngày tạo: {request.createdDate}</p>
              </div>
